...
def main() -> int:
    ...
    lines = [
        ...
        f"- Planner Session Resumable: {'yes' if meta.get('planner_session_resumable') else 'no'}",
        ...
        f"- Reviewer Session Resumable: {'yes' if meta.get('reviewer_session_resumable') else 'no'}",
